...
namespace CmisSync.Lib.FileTransmission {
    ...
    public class Transmission : INotifyPropertyChanged {
        ...
        private class TransmissionStream : Stream {
            ...
            public TransmissionStream(Stream wrappedStream, Transmission transmission) {
                this.bandwidthNotify = new BandwidthNotifyingStream(wrappedStream);
                this.abort = new AbortableStream(this.bandwidthNotify);
                this.pause = new PausableStream(this.abort);
                this.progress = new ProgressStream(this.pause);
